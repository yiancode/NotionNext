...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '218ed26c0da0804fbc28dc977e2f4ae8,en:7c1d570661754c8fbc568e00a01fd70e',
  // REDIS
  REDIS_URL: process.env.REDIS_URL || '', // REDIS连接字符串
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '易安', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'AI超级个体，AI编程，一人企业复利商业化', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yianlu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '易安的博客', // 网站关键词 英文逗号隔开
